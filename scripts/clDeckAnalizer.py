class CLDeckAnalizer:
    ...
    def getDeckType(self,df):
        ...
        return {
            ...
            'aruJixyura': self.getDeckInfo(aruJixyura),
            'reji': self.getDeckInfo(reji),
            'parukia': self.getDeckInfo(parukia),
            'kixyremu': self.getDeckInfo(kixyremu),
            'parukiaKixyremu': self.getDeckInfo(parukiaKixyremu),
            'kokuba': self.getDeckInfo(kokuba),
            'hakuba': self.getDeckInfo(hakuba),
            'lostzonebox': self.getDeckInfo(lostzonebox),
            'hapimiru': self.getDeckInfo(hapimiru),
            'arupika': self.getDeckInfo(arupika),
            'runasoru': self.getDeckInfo(runasoru),
            'zoroaku': self.getDeckInfo(zoroaku),
            'dogasudaina': self.getDeckInfo(dogasudaina),
            'dogasubatto': self.getDeckInfo(dogasubatto),
            'dainaburakki': self.getDeckInfo(dainaburakki),
            'erekiganon': self.getDeckInfo(erekiganon),
            ...
            'aruura': self.getDeckInfo(aruura),
            'aruseusu': self.getDeckInfo(aruseusu),
            'urakou': self.getDeckInfo(urakou),
            'hisuizoroaku': self.getDeckInfo(hisuizoroaku),
